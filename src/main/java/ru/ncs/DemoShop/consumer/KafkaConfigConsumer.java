...
public class KafkaConfigConsumer {
    ...
    private ConsumerFactory<String, ExchangeRate> consumerFactoryMessage() {
        ...
        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), new JsonDeserializer<>(ExchangeRate.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, ExchangeRate> kafkaListenerContainerFactoryMessage() {
